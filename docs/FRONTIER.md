...
| 2026-07-17 | Durable-harness consensus: verification, state-on-disk, and guardrails retain value as models improve; capability-compensating scaffolding rots ("the hard, valuable part of a loop is designing the check that decides when the work is done" — arXiv 2607.00038; "every component in a harness encodes an assumption about what the model can't do on its own" + "find the simplest solution possible" — Anthropic harness-design 2026-03-24; fresh-context judging "a strong lever" ibid.) | anthropic.com/engineering/harness-design-long-running-apps; arxiv.org/html/2607.00038v1 |
