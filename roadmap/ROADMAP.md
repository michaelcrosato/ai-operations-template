...
## Now
- Build the engine itself so it matches its own blueprint (agents, skills, hooks, gates, CI).
- Prove the whole loop end-to-end on one deliberately trivial feature before trusting it.

## Next
- Contract tests for every hook script — the safety net must be tested code, not vibes.
