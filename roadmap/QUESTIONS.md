...
**Update (2026-07-18) — the three unknowns above are now mostly answered; still nothing enabled, still your call:**
1. **OpenAI (Codex): your existing ChatGPT subscription covers it.** OpenAI's own pricing page now says plainly that both the Plus and Pro plans include the coding tool, with published usage allowances. The "does my plan unlock it" question is answered: yes. It remains the recommended starting point if you want a lane at all.
2. **xAI (Grok Build): the $30-to-$300 confusion is settled — there is no paywall to get in the door.** xAI's own pricing page shows the tool available on every plan, including the free one. (The scary price reports came from sites that couldn't see xAI's real pages.) What their pages don't say: whether free use is a short trial and how big the usage allowance is per plan — one sign-in would tell us.
