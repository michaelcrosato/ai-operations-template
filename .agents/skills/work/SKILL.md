...
- Anything you explained twice belongs in `AGENTS.md` (≤150 lines) or a path-scoped rule. Anything you did manually twice belongs in a script.
- Never block on a human (AGENTS.md §4): decide-and-document, or blocked-and-skip.
